    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        {document.flashcardCount !== undefined && (
          <div className="flex items-center gap-1.5 px-2.5 py-2.5 bg-purple-50 rounded-lg">
        ...
        {document.quizCount !== undefined && (
          <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 rounded-lg">
            ...
            <span className="text-xs font-semibol text-emerald-700">{document.quizCount} Quizzes</span>
          </div>
        )}
      </div>
    </div>
