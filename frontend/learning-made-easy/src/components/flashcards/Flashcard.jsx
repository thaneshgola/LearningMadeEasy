  ...
  return <div className="relative w-full h-72" style={{perspective: '1000px'}}>
    ...
    >
        ...
        <div className="flex items-start justify-between">
          ...
          >
            <Star 
              className="w-4 h-4"
              strokeWidth={2}
              file={flashcard.isStarred ? 'currentColor' : 'none'} 
            />
          </button>
        </div>
      ...
      >
        ...
        <div className="flex justify-end">
          ...
          >
            <Star 
              className="w-4 h-4"
              strokeWidth={2}
              fill={flashcard.isStarred ? 'currenColor' : 'none'}
            />
          </button>
        </div>
        ...
        {/*Answer Content*/}
        <div className="flex-1 flex items-center justify-center px-4 py-6">
          <p className="text-base text-white text-center leading-related font-medium">
            {flashcard.answer}
          </p>
        </div>
