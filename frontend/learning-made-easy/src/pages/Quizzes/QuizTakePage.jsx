          ...
          {currentQuestion.options.map((option, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Custom Radio Button */}
                <div className={`shrink-0 w-5 h-5 rounded-full border-2 transition-all durayion-200 ${
                  isSelected
