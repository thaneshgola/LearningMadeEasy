      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="w-full max-w-2xl">
            ...
            /> */}
            <Flashcard key={currentCardIndex} flashcard={currentCard} onToggleStar={handleToggleStar} />
          </div>
    ...
    if(flashcardSets.length === 0) {
      return(
        <div className="flex flex-col items-center justify-center py-16 px-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 mb-0">
          ...
          >
            {generating ? (
              <>
                <div className="-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                Generating...
              </>
            ) : (
              <>
